...
latex_documents = [
    (master_doc, "kernel_tuner.tex", "Kernel Tuner Documentation", "Ben van Werkhoven", "manual"),
]
...
man_pages = [(master_doc, "kernel_tuner", "Kernel Tuner Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "kernel_tuner",
        "Kernel Tuner Documentation",
        author,
        "kernel_tuner",
        "A simple CUDA/OpenCL Auto-Tuner in Python",
        "Miscellaneous",
    ),
]
